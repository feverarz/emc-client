...
export function imprimir(periodo,alumno,cursadas,descargar){
    try{
        generarComprobante(periodo,alumno,cursadas,descargar)
    }catch(err){
...
function generarComprobante(periodo,alumno,cursadas,descargar) {
    ...
    var docDefinition = {
        ...
        content: [
           ...
           /* {
            ...
            {
                text: `Comprobante de inscripción`, margin: [2, 50], style: 'center'
            },
